      ...
      <div className="container px-6 mx-auto py-8 md:py-12">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground">
          ...
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/company/anubis-ai-agency" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">LinkedIn</a>
